    ...
    <>
      ...
      <form className="mt-8 space-y-5">
        ...
        <div className="flex items-center justify-between gap-4 text-sm">
          ...
          <button type="button" className="font-medium text-blue-900 transition hover:text-zinc-900">
            Forgot Password?
          </button>
        </div>
      ...
      <div className="mt-8 border-t border-zinc-200 pt-6 text-sm text-yellow-600">
        No account yet?{' '}
        <Link to="/auth/signup" className="font-semibold text-blue-900 transition hover:text-zinc-600">
          Sign Up
        </Link>
      </div>
    </>
