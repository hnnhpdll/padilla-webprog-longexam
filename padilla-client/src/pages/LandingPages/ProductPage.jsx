...
function ProductPage() {
  ...
  return (
    <div className="flex w-full flex-col gap-6">
      ...
      <section className="border-y-2 border-blue-900 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="max-w-3xl">
          <div className="mb-4">
            <Button to="/products">Back to Products</Button>
          </div>
          <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.28em] text-yellow-600">
            {product.category}
          </p>
      ...
      <section className="border-y-2 border-blue-900 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="mx-auto max-w-3xl">
          <div className="mx-auto max-w-3xl">
  <div className="mb-8 flex aspect-4/3 items-center justify-center rounded-[1.25rem] border-2 border-blue-900 bg-zinc-200 overflow-hidden">
    ...
    />
          ...
          <div className="prose prose-sm max-w-none space-y-4 text-zinc-700">
            {product.content.map((paragraph, index) => (
              <p key={index} className="text-base leading-7 text-yellow-600 whitespace-pre-wrap">
                {paragraph}
              </p>
            ))}
          </div>
